...
public class MainMenu {
    ...
    private static void printHeroClasses() {
        ...
        ==--==--==--==--==--==--== MUTANT ==--==--==--==--==--==--==
         ...
         habilities and power beyond the common beings and use them
         to save people.
        ...
        ==--==--==--==--==--==-- SPECIALIST --==--==--==--==--==--==
         ...
         powers, fight for whatis right. They normally depend on
         weapons, and are proficient in many of them.
         Real life examples: Batman, Hawkeye, Green Arrow...

         The whole class depends on their preffered Weapon.
