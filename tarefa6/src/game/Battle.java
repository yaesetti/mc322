...
public class Battle implements Serializable {
     ...
     * <p>
     * Initializes the hero (a {@link Mutant}) named "Singed" and equips them with a custom gauntlet.
    ...
    /**
     * Advances the battle to the next level by incrementing the level index.
     */
